...
def test_dynamodb_prod_billing_is_provisioned(prod_template):
    # PROVISIONED mode omits the BillingMode key in CloudFormation.
    # Presence of ProvisionedThroughput is the correct indicator.
    # The initial values are CDK defaults — auto-scaling manages capacity after that.
...
def test_lambda_function_created(dev_template):
